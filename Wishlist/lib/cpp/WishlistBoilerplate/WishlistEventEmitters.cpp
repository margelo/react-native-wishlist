...
void WishlistEventEmitter::onBubblingEventDefinedInline(OnBubblingEventDefinedInline event) const {
...
void WishlistEventEmitter::onDirectEventDefinedInline(OnDirectEventDefinedInline event) const {
...
void WishlistEventEmitter::onDirectEventDefinedInlineWithPaperName(OnDirectEventDefinedInlineWithPaperName event) const {
