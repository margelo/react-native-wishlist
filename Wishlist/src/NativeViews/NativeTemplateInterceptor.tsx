...
type NativeType = HostComponent<NativeTemplateInterceptorProps>;

export default (codegenNativeComponent<NativeTemplateInterceptorProps>('MGTemplateInterceptorComponent') as NativeType);