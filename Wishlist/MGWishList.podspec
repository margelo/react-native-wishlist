...
Pod::Spec.new do |s|
  ...
  s.subspec 'Container' do |sp|
    sp.source_files = 'lib/cpp/ContainerBoilerplate/*.{cpp,h,m,mm,hpp}'
  end

  s.subspec 'Interceptor' do |sp|
    sp.source_files = 'lib/cpp/InterceptorBoilerplate/*.{cpp,h,m,mm,hpp}'
  end

  s.subspec 'Wishlist' do |sp|
    sp.source_files = 'lib/cpp/WishlistBoilerplate/*.{cpp,h,m,mm,hpp}'
  end
