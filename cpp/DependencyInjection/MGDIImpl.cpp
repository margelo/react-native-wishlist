...
void MGDIImpl::setDataBindingImpl(std::shared_ptr<MGDataBindingImpl> dataBinding) {
    this->dataBinding = dataBinding;
}

void MGDIImpl::setOrchestratorCppAdaper(std::shared_ptr<MGOrchestratorCppAdapter> orchestratorAdapter) {
    this->orchestratorAdapter = orchestratorAdapter;
}

void MGDIImpl::setViewportCarerImpl(std::shared_ptr<MGViewportCarerImpl> viewportCarerImpl) {
